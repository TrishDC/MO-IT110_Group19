...
public abstract class SalaryCalculator implements SalaryCalculator_Interface{
    ...
    public void BigDecimal computeMonthlyPay(Employee emp, YearMonth ym) {
     ...
     * @param grossMonthly
     * @return  */
    public void  BigDecimal computeSssDeduction(BigDecimal grossMonthly) {
     ...
     * @param pagIbig
     * @return  */
    public  void  BigDecimal computeWithholdingTax(
        BigDecimal earnings,
        BigDecimal sss,
