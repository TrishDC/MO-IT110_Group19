...
public class PayslipSplitDialog extends JDialog {
  ...
  SalaryCalculator_Interface a = SalaryCalulator();
    ...
    private void doCompute() {
        ...
        BigDecimal sssDed  = computeSssDeduction(gross);
        BigDecimal philDed = computePhilHealthDeduction(gross);
        ...
        BigDecimal tax = computeWithholdingTax(earned, sssDed, philDed, pagDed);
